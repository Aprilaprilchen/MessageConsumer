...
//      now the configuration message has been loaded which means added into the properties
            properties.load(input);
            System.out.println("We are currently using configuration file: " + input.toString());
        }catch (IOException e){
            ...
            System.out.println("We are currently using VM option");
            //e.printStackTrace();
        }
...
//      directly put configuration message in the code:
